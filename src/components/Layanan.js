      ...
      <div class="container">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <h4><Link to="/create" class="btn btn-primary"><MdAdd/> Add layanan</Link></h4>
              ...
              <tbody>
                {this.state.layanan.map(layanan =>
                  <tr>
                    ...
                    <Link to={`/edit/${layanan.key}`} class="btn btn-success"><FaEdit/> Edit</Link>&nbsp;
                    <Link to={`/show/${layanan.key}`} class="btn btn-warning"><BiDetail/> Show</Link>&nbsp;
